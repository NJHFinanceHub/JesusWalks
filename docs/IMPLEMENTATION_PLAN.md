...
- **Player Skill Tree**: static skill graph (UE5 runtime skill tree module) + player unlock state, XP gating, save/load persistence.
...
## Trade-offs
- Kept prototype systems data-driven in UE5 C++/Blueprint rather than adding editor-authored assets/scenes so features remain testable in this repository without external dependencies.
